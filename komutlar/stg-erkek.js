...
if(!['773104372028407818'].some(role => message.member.roles.cache.get(role)) && !message.member.hasPermission('773104372028407818')) 
return message.reply(`Bu Komut İçin Yetkiniz Bulunmamaktadır.`) 
  
const erkek = message.guild.roles.cache.find(r => r.id === '769216654591787019')
const erkek2 = message.guild.roles.cache.find(r => r.id === '790166797344833546')
const kayıtsız = message.guild.roles.cache.find(r => r.id === '770754066824429588')
const savelogs = message.guild.channels.cache.find(c => c.id === '772894132472512572')
...
.addField(`Roller`, `${erkek}, ${erkek2}`, true)
...
.setFooter('Türkiyem Albayrak Gaming')
