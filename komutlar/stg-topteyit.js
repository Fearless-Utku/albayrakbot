...
if(!message.member.roles.cache.some(r => ['773104372028407818', '772895214028980234'].includes(r.id)) && (!message.member.hasPermission("773104372028407818")))return message.reply("Bu Komutu Kullanmak İçin Yetkiniz Bulunmamakta.")  
