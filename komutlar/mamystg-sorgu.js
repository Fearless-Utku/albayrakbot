...
exports.run = async (client, message, args) => {
    ...
    if(!message.member.roles.cache.some(r => ["770770216912158750", "773104372028407818"].includes(r.id)) && (!message.member.hasPermission("773104372028407818")))
...
.setFooter(`Türkiyem Albayrak Gaming`) // evet bilerek kaldırmadım ayriyetten sıfırdan yazdım :)
